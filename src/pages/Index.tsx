...
const deliverables = [
  { code: "01", title: "Проектная и рабочая документация", desc: "Полный комплект чертежей по СанПиН, СП и отраслевым нормам — готовый к строительству и согласованию." },
  { code: "02", title: "Согласование и СЭЗ", desc: "Сопровождаем в Роспотребнадзоре, ФМБА, при необходимости — в Минздраве. Получаете санитарно-эпидемиологическое заключение." },
  { code: "03", title: "Поддержка до лицензии", desc: "Готовим пакет для Росздравнадзора, отвечаем на замечания, проходим выездную проверку вместе с вами." },
  { code: "04", title: "Авторский надзор на стройке", desc: "Контролируем подрядчика, чтобы инженерия, отделка и зонирование собрались точно по проекту." },
  { code: "05", title: "Поставка оборудования и мебели", desc: "Подбираем и поставляем медицинскую технику и мебель напрямую от производителей под ваш проект." },
  { code: "06", title: "Один ответственный инженер", desc: "Не диспетчер и не чат — ваш проект ведёт конкретный человек с прямым контактом до сдачи объекта." },
];
