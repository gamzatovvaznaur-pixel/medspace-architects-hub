...
const steps = [
  ...
  },
  {
    ...
    text: "Получаем СЭЗ на ваш юридический адрес. С этим документом вы готовы подавать заявление на медицинскую лицензию.",
    duration: "включено в этап 4",
  },
  {
    title: "Сопровождение лицензирования в Росздравнадзоре",
...
const includes = [
  ...
  "Сопровождение получения лицензии в Росздравнадзоре",
...
const faq = [
  {
    ...
    a: "В среднем 3–5 месяцев. Проектирование — 1–1,5 месяца, согласование СЭЗ — 30–45 рабочих дней, лицензирование — ещё 30–45 дней. Если помещение требует серьёзных переделок, добавляется время на стройку.",
  },
  {
