...
import { FileText, Download, Shield, Building2, Zap, Scale, BookOpen, Radiation } from "lucide-react";

const documentCategories = [
  {
    title: "Справочные материалы",
    icon: BookOpen,
    description: "Аналитические и методические материалы по проектированию медицинских объектов",
    documents: [
      {
        name: "Анатомия медицинского проекта",
        title: "Medical Design Anatomy Blueprint — структура нормативной базы медицинского проектирования",
        description: "Наглядный справочник по уровням нормативного регулирования: от архитектурного каркаса (СП 158, СП 59, 123-ФЗ) до инженерных систем (СП 60, СП 256), гигиены (СанПиН) и лицензирования (Приказы Минздрава).",
        file: "/documents/medical-design-blueprint.pdf",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: Radiation,
    description: "Нормативы по устройству рентгеновских кабинетов и работе с источниками ионизирующего излучения",
    documents: [
      {
        name: "СанПиН 2.6.1.1192-03",
        title: "Гигиенические требования к устройству и эксплуатации рентгеновских кабинетов, аппаратов и проведению рентгенологических исследований",
        description: "Определяет требования к размещению, планировке и защите рентгеновских кабинетов, расчёту радиационной защиты стен, дверей и смотровых окон, а также порядку проведения исследований.",
        file: "/documents/sanpin-2.6.1.1192-03.pdf",
      },
    ],
  },
  {
  ...
  {
    title: "Своды правил (СП) — инженерные системы и безопасность",
    icon: Zap,
    description: "Нормативные документы по инженерному оснащению, пожарной безопасности и климатическим системам",
    documents: [
      {
        name: "СП 60.13330.2020",
        title: "Отопление, вентиляция и кондиционирование воздуха",
        description: "Регулирует проектирование систем отопления, вентиляции и кондиционирования в зданиях, включая специальные требования к микроклимату и чистоте воздуха в медицинских помещениях.",
        file: "/documents/sp-60.13330-2020.pdf",
      },
      {
      ...
      },
      {
        ...
        title: "Ограничение распространения пожара на объектах защиты",
  ...
  {
    title: "Федеральные законы и постановления",
    icon: Scale,
    description: "Законодательные акты федерального уровня, определяющие базовые требования к медицинским объектам",
    documents: [
      {
        name: "123-ФЗ",
        title: "Технический регламент о требованиях пожарной безопасности",
        description: "Федеральный закон, устанавливающий минимально необходимые требования пожарной безопасности к зданиям и сооружениям, включая классификацию по функциональной пожарной опасности и требования к путям эвакуации.",
        file: "/documents/fz-123-pozharnaya-bezopasnost.pdf",
      },
      {
        name: "Постановление Правительства РФ № 852",
        title: "О лицензировании медицинской деятельности",
        description: "Определяет положение о лицензировании медицинской деятельности, перечень работ и услуг, требования к помещениям и оборудованию, необходимые для получения лицензии.",
        file: "/documents/pp-852-licenzirovanie.pdf",
      },
    ],
  },
  {
    ...
    icon: FileText,
    description: "Порядки оказания медицинской помощи по профилям — определяют требования к помещениям, оборудованию и штатному расписанию",
    documents: [
      {
      ...
      {
        name: "Приказ Минздрава РФ № 924н",
        title: "Порядок оказания медицинской помощи больным с сердечно-сосудистыми заболеваниями",
        description: "Устанавливает стандарты оснащения кардиологических подразделений, требования к помещениям, оборудованию и организации кардиологической помощи.",
        file: "/documents/prikaz-924n.pdf",
      },
      {
        name: "Приказ Минздрава РФ № 1130н",
        title: "Порядок оказания медицинской помощи по профилю «акушерство и гинекология»",
        description: "Определяет требования к организации акушерско-гинекологической помощи, стандарты оснащения родильных домов, перинатальных центров и женских консультаций.",
        file: "/documents/prikaz-1130n.pdf",
      },
      {
