  ...
  return (
    <>
      ...
      <ServiceBlock
        ...
        description="Берём на себя весь процесс прохождения государственной экспертизы и согласования в органах архитектурно-строительного надзора. Наш опыт в 142+ согласованных проектах позволяет предвидеть и устранять замечания до их появления."
        details={[
